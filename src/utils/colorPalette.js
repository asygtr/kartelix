...
const COLOR_PALETTES = {
  ...
  'optic white':   { bg: '#fbfaf5', bgDeep: '#f0eee6', surface: 'rgba(255,255,252,0.96)', border: 'rgba(126,118,102,0.16)', accent: '#746f63', accentDeep: '#4f4a43', swatch: '#fbfaf4', swatchDeep: '#e4e0d4', text: '#171a1c', textMuted: '#6e746f', grad: '180deg', glow: 'rgba(126,118,102,0.12)' },
  'white':         { bg: '#fbfaf5', bgDeep: '#f0eee6', surface: 'rgba(255,255,252,0.96)', border: 'rgba(126,118,102,0.16)', accent: '#746f63', accentDeep: '#4f4a43', swatch: '#fbfaf4', swatchDeep: '#e4e0d4', text: '#171a1c', textMuted: '#6e746f', grad: '180deg', glow: 'rgba(126,118,102,0.12)' },
  'beyaz':         { bg: '#fbfaf5', bgDeep: '#f0eee6', surface: 'rgba(255,255,252,0.96)', border: 'rgba(126,118,102,0.16)', accent: '#746f63', accentDeep: '#4f4a43', swatch: '#fbfaf4', swatchDeep: '#e4e0d4', text: '#171a1c', textMuted: '#6e746f', grad: '180deg', glow: 'rgba(126,118,102,0.12)' },
